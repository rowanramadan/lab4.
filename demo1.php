...
<h2>User.<a href="step.php"><input type="button" name="add new user"value="add new user"style="margin-left: 200px;background-color:green;color:white;border-radius:3px;height:25px;"></a></h2><hr>
